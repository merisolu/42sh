...
#    Updated: 2023/02/03 15:22:06 by jumanner         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
BUILT_INS_FILES = built_ins.c built_ins_flags.c cmd_cd.c cmd_echo.c \
				cmd_fc.c cmd_fc_editor.c cmd_fc_editor_write.c \
				cmd_fc_editor_read.c cmd_fc_range.c cmd_fc_replace.c \
				...
				cmd_jobs.c cmd_fg.c cmd_bg.c fg_bg_utils.c cmd_test.c
...
HISTORY_FILES = history.c history_save.c history_load.c history_search.c \
				...
				history_expansions.c history_expansions_inhibition.c
